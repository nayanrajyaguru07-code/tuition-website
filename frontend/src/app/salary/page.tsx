      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {activeTab === "pay" ? (
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
             {employees.map((emp) => (
               <div key={emp.id} className="bg-white rounded-2xl shadow-sm border border-orange-100 p-6 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center text-center group">
                 ...
                 <h3 className="text-lg font-bold text-gray-800 group-hover:text-orange-600 transition-colors">{emp.name}</h3>
                 ...
                 <div className="w-full bg-orange-50/50 rounded-lg p-3 mb-4 border border-orange-100">
                   <p className="text-xs text-orange-400 uppercase tracking-wide font-semibold">Base Salary</p>
                   <p className="text-xl font-bold text-gray-800">₹{emp.salary ?? 0}</p>
                 </div>
                    ...
                    payments.map((p) => (
                      <tr key={p.id} className="hover:bg-orange-50/30 transition-colors group">
                        ...
                        <td className="px-6 py-4 text-gray-600">
                          <span className="bg-orange-100 text-orange-700 px-2 py-1 rounded text-xs font-semibold">{p.salaryMonth}</span>
                        </td>
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
              <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                <h3 className="font-bold text-lg text-gray-800">
                  {editingPaymentId ? "Edit Payment" : "Pay Salary"} - <span className="text-orange-600">{selectedEmployee.name}</span>
                </h3>
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                   ...
                   <SearchableSelect
                     ...
                     onChange={(val) => setPayForm({...payForm, paymentMethod: String(val)})}
